...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder>{
    ...
    private ArrayList<id.ac.pelitabangsa.uas_satriaaryapratama.Activity.DataFilter> dataList;
    private Context context;

    RecyclerViewAdapter(ArrayList<id.ac.pelitabangsa.uas_satriaaryapratama.Activity.DataFilter> dataList){
    ...
    void setFilter(ArrayList<id.ac.pelitabangsa.uas_satriaaryapratama.Activity.DataFilter> filterList){
